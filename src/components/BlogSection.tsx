...
const posts: BlogPost[] = [
  {
    tag: "Frontend",
    readTime: "5 min read",
    title: "Building Performant React Applications with Suspense",
    excerpt: "Exploring concurrent features in React 18 and how Suspense boundaries improve perceived performance.",
    date: "Feb 15, 2026",
  },
  {
    tag: "Backend",
    readTime: "8 min read",
    title: "Designing Type-Safe REST APIs with Express and Zod",
    excerpt: "How schema validation at the edge eliminates an entire class of runtime errors in production.",
    date: "Jan 28, 2026",
  },
  {
    tag: "Architecture",
    ...
    excerpt: "Practical patterns for building resilient event-driven systems with RabbitMQ and Node.js.",
    date: "Jan 10, 2026",
  },
];
            ...
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-xs font-display font-medium gradient-bg text-primary-foreground px-2 py-0.5 rounded">
                    {post.tag}
                  </span>
